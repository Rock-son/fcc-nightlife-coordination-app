...
_reactDom2.default.render(_react2.default.createElement(
    ...
    _react2.default.createElement(
        ...
        null,
        _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', component: _Main.AppWrapper }),
...
var _actionCreators = __webpack_require__(111);
    ...
    _createClass(Main, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement(_Navbar.Navbar, { props: this.props.auth }),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        login: function login() {
            return dispatch((0, _actionCreators.loginUser)());
        },
        logout: function logout() {
            return dispatch((0, _actionCreators.logoutUser)());
        }
    };
};

var Container = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Main);

var AppWrapper = exports.AppWrapper = function (_React$Component2) {
...
var authReducer = function authReducer() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _initialState.initialAuth;
...
var searchReducer = function searchReducer() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _initialState.initialSearch;
	var action = arguments[1];
...
var initialAuth = exports.initialAuth = { authenticated: false };

var initialSearch = exports.initialSearch = { searchStr: "" };
...
var Navbar = exports.Navbar = function (_React$Component) {
    ...
    _createClass(Navbar, [{
        key: "render",
        value: function render() {
            var isAuth = this.props.authenticated;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        { onClick: this.props.login, style: { display: isAuth ? "none" : "inline-block" }, className: "navbar__right__login", to: "/" },
                        "Login"
                    ),
                    _react2.default.createElement(
                        _reactRouterDom.Link,
                        { onClick: this.props.logout, style: { display: isAuth ? "inline-block" : "none" }, className: "navbar__right__login", to: "/" },
                        "Logout"
                    )
                )
            );
...
function Footer(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                "a",
                { className: "footer__codedby__link", href: "https://codepen.io/Roky/full/YqGqWg", target: "_blank", rel: "noopener" },
                " Roky "
            ),
            _react2.default.createElement(
                "span",
            ...
            _react2.default.createElement(
                "a",
                { className: "footer__codedby__link", href: "https://github.com/Rock-son/Dynamic-web-projects", target: "_blank", rel: "noopener" },
                "GitHub Repository"
            )
        )
    );
...
//# sourceMappingURL=bundle.8784ca027afb846da8ca.js.map